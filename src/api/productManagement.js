...
// 生成企业邀请码同步产品
export function companyProduct_getShare() {
    return request({
        url: '/productManagement/companyProducts/getShare',
        method: 'get',
    })
}

// 填写邀请码同步产品
export function companyProducts_verify(params) {
    return request({
        url: '/productManagement/companyProducts/verify',
        method: 'get',
        params,
    })
}

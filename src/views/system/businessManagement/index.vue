  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch">
      <el-form-item label="企业名称" prop="name">
        <el-input v-model="queryParams.name" placeholder="请输入企业名称" clearable style="width: 200px"
    ...
    <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="法人" align="center" prop="legalPerson" :show-overflow-tooltip="true" />
      <!-- <el-table-column label="联系电话" align="center" prop="phone" :show-overflow-tooltip="true" /> -->
      <el-table-column label="企业地址" align="center" prop="address" :show-overflow-tooltip="true" />
...
import { listBusinessManagement } from "@/api/system/businessManagement"
...
function getList () {
  loading.value = true
  listBusinessManagement(queryParams.value).then(response => {

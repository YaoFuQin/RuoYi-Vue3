<template>
  <foreignObject class="editor-component-item" v-bind="wrapperAttrs" @click="handleEvent('click', $event)"
    @dblclick="handleEvent('dblclick', $event)">

    <img v-bind="state" class="full-width full-height widget-image" :style="styleImgName" :src="mapData.src"
      v-if="mapData.src" />
...
defineOptions({
  ...
  defaultValue: {
    ...
    states: [
      {
        src: 'https://bpic.51yuansu.com/pic2/cover/00/33/90/581139f36ad72_610.jpg?x-oss-process=image/sharpen,100',
        style: {

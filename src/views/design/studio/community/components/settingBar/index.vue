<template>
  <div>
    <el-form label-width="90px" label-position="left" v-if="pageConfig">
      ...
      <datavis-setting-bar-size ref="pageSizeBarRef" v-model:config="pageConfig"
        @change="handleChangeSize"></datavis-setting-bar-size>
      <datavis-setting-bar-background v-model:config="pageConfig" @change="handleChange" @recover="handleRecover">
      </datavis-setting-bar-background>
    </el-form>
  </div>
</template>

<template>
  <el-dialog v-bind="attrs" modal-append-to-body v-model="visible" destroy-on-close :close-on-click-modal="false"
    title="数据编辑" width="80%" class="datavis-table-data-dialog">
    ...
    <visui-code-editor ref="codeEditorRef" style="height: 400px" v-show="state.type === 'json'" :code="code"
      :config="codeConfig">
    </visui-code-editor>
    <template #footer>
